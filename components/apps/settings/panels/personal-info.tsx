...
const devices: Device[] = [
  { name: "Sanjiv's MacBook Pro", model: "This MacBook Pro", type: "macbook" },
  { name: "Sanjiv's iPhone 17 Pro", model: "iPhone 17 Pro", type: "iphone" },
  { name: "Sanjiv's iPad", model: "iPad Air", type: "ipad" },
        ...
        <div className="divide-y divide-border/50">
          ...
          >
            ...
            <div className="flex items-center gap-1 text-muted-foreground">
              <span className="text-xs">Sanjiv Prabhunandan</span>
              <ChevronRight className="w-4 h-4" />
            </div>
          </a>
          <div className="flex items-center justify-between px-4 py-3">
            <span className="text-xs">Birthday</span>
            <span className="text-xs text-muted-foreground">4/5/1998</span>
          </div>
        </div>
      </div>
