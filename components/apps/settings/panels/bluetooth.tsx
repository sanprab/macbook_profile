...
const myDevicesDesktop: BluetoothDevice[] = [
  { name: "Sanjiv's Magic Keyboard", connected: true, battery: 91, type: "keyboard" },
  { name: "Sanjiv's Magic Trackpad", connected: true, battery: 20, type: "trackpad" },
  { name: "Nothing Headphones", connected: false, type: "headphones" },
  { name: "Sanjiv's AirPods Max", connected: false, type: "airpods-max" },
  { name: "Sanjiv's AirPods Pro", connected: false, type: "airpods" },
  { name: "Flipper Reg0l1", connected: false, type: "headphones" },
];

const myDevicesMobile = [
  { name: "Nothing Headphones", connected: true },
  { name: "Sanjiv's AirPods Max", connected: false },
  { name: "Sanjiv's AirPods Pro", connected: false },
    ...
    return (
      <div className="px-4 py-4 space-y-4">
        ...
        <p className="text-sm text-muted-foreground px-2">
          This iPhone is discoverable as &quot;sanjiv&apos;s iphone&quot; while Bluetooth Settings is open.
        </p>
      ...
      {bluetoothEnabled && (
        <>
          ...
          <p className="text-xs text-muted-foreground py-4 border-b border-border/50">
            This Mac is discoverable as &quot;Sanjiv&apos;s MacBook Pro&quot; while Bluetooth Settings is open.
          </p>
