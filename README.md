...
- **dock shortcuts**: GitHub opens [@sanprab](https://github.com/sanprab) and X opens [@snjvpr](https://x.com/snjvpr) in new tabs; Chrome, Notion, Sublime Text, Codex, Claude Code, Maps, and Copilot Money are display-only icons
...
`git clone https://github.com/sanjivgoyal/sanjivgoyal`
...
4. paste the sql from the [migration file](https://github.com/sanjivgoyal/sanjivgoyal/blob/main/supabase/migrations/20240710180237_initial.sql) into the sql editor and press run
...
licensed under the [mit license](https://github.com/sanjivgoyal/sanjivgoyal/blob/main/LICENSE.md).
